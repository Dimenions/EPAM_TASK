...
namespace CycledDynamicArray
{
    public class CycledDynamicArray<T> : IEnumerable, IEnumerable<T>, ICloneable
    {
        ...
        private void IncreaseCapacity(int multiplier = 2) //Множитель на увеличение вместимости
        {
        ...
        public T this[int index]
        {
            get
            {
                // Если значение меньше нуля или больше количества объектов, то кидаем exception
